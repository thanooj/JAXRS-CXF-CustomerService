...
public class CustomerDAOImpl extends JdbcDaoSupport implements CustomerDAO {
	...
	public void statup() {
		try {
			dropTable();
			logger.info("drop customer table sql statement has been successfully executed.");
			ScriptUtils.executeSqlScript(getConnection(), new ClassPathResource("db-schema.sql"));
			logger.info("create customer table sql statement has been successfully executed.");
		} catch (Exception e) {
